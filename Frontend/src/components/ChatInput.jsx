...
function ChatInput() {
  ...
  return (
    <div className="w-full overflow-hidden px-3 md:px-5 py-4 border-t border-white/[0.03] border border-white/[0.07] rounded-2xl px-4 pt-3.5 pb-3">
            ...
            {selectedFile?.type === "application/pdf" ? (
              ...
              selectedFile.type.startsWith("image/") && (
                <img
                  ...
                  className="h-10 rounded-xl object-cover mt-3"
                />
              )
            )}
            <div>
