...
function BillingDrawer({ open, onClose }) {
  ...
  const handleUpgrade = async (plan) => {
    try {
      ...
      console.log("RAZORPAY ORDER AMOUNT:", data?.order?.amount);
          ...
          >
            ...
            <div className="px-5 flex-1 overflow-auto space-y-4">
              <div className="rounded-xl border border-white/10 p-4">
                <h3 className="text-while font-semibold">Starter Plan</h3>
              ...
              <div className="rounded-xl border border-white/10 p-4">
                <h3 className="text-while font-semibold">Pro Plan</h3>
