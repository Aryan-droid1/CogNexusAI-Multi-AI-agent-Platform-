...
function SideBar() {
  ...
  if (collapsed) {
    return (
      <div className="hidden sm:flex flex-col items-center w-[56px] h-screen bg-[#0d0f14] border-r border-white/[0.06] py-4 gap-1 shrink-0">
        <button
  ...
  return (
    <>
    <button className="block sm:hidden fixed top-3.5 left-4 z-[100] flex items-center justify-center w-8 h-8 rounded-lg bg-[#0d0f14] border border-white/[0.06] text-slate-400 hover:text-slate-200 transition-colors duration-150 cursor-pointer" onClick={()=>setMobileOpen(prev => !prev)}>
    <Menu size={14}/>

    </button>
    {mobileOpen && <div className="sm:hidden fixed inset-0 z-40 bg-black/50 backdrop-blur-sm"/>}
    
 <div className={`fixed sm:static inset-y-0 left-0 z-50 w-[270px] h-screen shrink-0 bg-[#0d0f14] border-r border-white/[0.06] transition-transform duration-250 ${mobileOpen ? "translate-x-0":"-translate-x-full sm:translate-x-0"}`}>
      ...
      <div className="flex flex-col h-full">
        <div className="flex items-center gap-2.5 px-4 py-4 border-b border-white/[0.06]">
          ...
          <div
            className="hidden sm:flex items-center justify-center w-7 h-7 rounded-lg text-slate-500 hover:text-slate-200 hover:bg-white/[0.05] transition-colors duration-150 bg-transparent border-none cursor-pointer"
          ...
          className="sm:hidden flex items-center justify-center w-7 h-7 rounded-lg text-slate-500 hover:text-slate-200 hover:bg-white/[0.05] transition-colors duration-150 bg-transparent border-none cursor-pointer">
            <X/>
          </button>
            ...
            <div className="flex items-center gap-2.5 cursor-pointer rounded-xl px-3 py-2.5 hover:bg-white/[0.05] transition-colors duration-150">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[11px] text-slate-600 mt-px">
                  {userData?.plan ? `${userData.plan} ` : "Free plan"}
                </p>
              </div>
              <button 
